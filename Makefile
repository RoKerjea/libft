...
#    Updated: 2021/07/26 18:56:33 by rokerjea         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS	= ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascci.c ft_isprint.c
...
SRCS:= $(SRCS) ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c
...
${NAME}:	${HEAD} ${OBJECTS} ar rcs ${NAME} ${OBJECTS}
